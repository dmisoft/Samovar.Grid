...
namespace Samovar.Blazor
{
    public interface IJsService
    {
        ...
        Task AttachOnScrollollingEvent(string InnerDataGridId, DotNetObjectReference<IVirtualScrollingService> InnerDataGridDotNetRef);

        Task DetachOnScrollollingEvent(string InnerDataGridId, DotNetObjectReference<IVirtualScrollingService> InnerDataGridDotNetRef);
