            ...
            : IJsService, IAsyncDisposable
{
    ...
    public async Task StartDataGridColumnWidthChangeMode(DotNetObjectReference<IColumnResizingService> colResizingService, double GridColWidthSum, string ColMetaId, string InnerGridId, string InnerGridBodyTableId, string VisibleGridColumnCellId, string HiddenGridColumnCellId, string FilterGridColumnCellId, string SummaryGridColumnCellId, string VisibleEmptyColumnId, string HiddenEmptyColumnId, string FilterEmptyColumnId, string EmptyColumnDictId, double StartMouseMoveX, double OldAbsoluteVisibleWidthValue, string FitColumnsToTableWidth, double OldAbsoluteEmptyColVisibleWidthValue, string? RightSideColMetaId, string? RightSideCellMetaId, double? RightSideColumnWidth, string? RightSideFilterCellId, string? RightSideHiddenCellId, string? RightSideSummaryCellId, string OuterGridId, double triggerColumnMinWidth, double rightSideColumnMinWidth)
    {
        await (await JsModule()).InvokeVoidAsync("startColumnWidthChangeMode", colResizingService, GridColWidthSum, ColMetaId, InnerGridId, InnerGridBodyTableId, VisibleGridColumnCellId, HiddenGridColumnCellId, FilterGridColumnCellId, SummaryGridColumnCellId, VisibleEmptyColumnId, HiddenEmptyColumnId, FilterEmptyColumnId, EmptyColumnDictId, StartMouseMoveX, OldAbsoluteVisibleWidthValue, FitColumnsToTableWidth, OldAbsoluteEmptyColVisibleWidthValue, RightSideColMetaId, RightSideCellMetaId, RightSideColumnWidth, RightSideFilterCellId, RightSideHiddenCellId, RightSideSummaryCellId, OuterGridId, triggerColumnMinWidth, rightSideColumnMinWidth);
    }
